# Generated by Powerlevel10k configuration wizard on 2020-12-10 at 15:14 EST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_DIR_BACKGROUND=4 ("dracula magenta")
  # Default current directory foreground color. (~ "dracula light raisin black")
  ...
  # Color of the shortened directory segments. (~ "dracula lighter raisin black")
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=237
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor. (~ "dracula raisin black")
