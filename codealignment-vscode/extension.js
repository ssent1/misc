...
function activate(context) {
    ...
    subscribeCommand(context, 'codealignment.alignbypound', () => doAlignment('#', false, true));
    subscribeCommand(context, 'codealignment.alignbycolon', () => doAlignment(':', false, true));
    subscribeCommand(context, 'codealignment.alignbyarrow', () => doAlignment('→', false, true));
}
